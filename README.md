...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/polished-field-9853#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/polished-field-9853
```

A live public deployment of this template is available at [https://polished-field-9853.templates.workers.dev](https://polished-field-9853.templates.workers.dev)
